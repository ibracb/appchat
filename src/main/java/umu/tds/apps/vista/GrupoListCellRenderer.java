...
public class GrupoListCellRenderer extends JPanel implements ListCellRenderer<Grupo> {
	...
	@Override
	public Component getListCellRendererComponent(JList<? extends Grupo> list, Grupo grupo, int index,
			boolean isSelected, boolean cellHasFocus) {
		
		String fotoGrupo = grupo.getImagen();
		URL url = getClass().getResource(fotoGrupo);
		if (url != null) {
